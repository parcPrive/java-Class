...
<div class="container">
	<form action="../member/modify-process" method="post" class=""
		id="joinForm" name="member" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-6">
							<label for="userID" class="form-label">ID</label> <input
								...
								placeholder="user id" name="userID" disabled
								value="${loggedID }" />
						</div>
					</div>
				</div>
			...
			<div class="col-6">
				<div class="mb-3">
					<label for="detailAddress" class="form-label">Detail
						...
						value="${modifyMember.detailAddress }" />
				</div>
			</div>
		</div>
		<div class="row d-flex justify-content-center">
			<div class="col-6">
				<div class="mb-3">
					<label for="detailAddress" class="form-label">profile</label> <input
						type="file" class="form-control" id="profile"
						placeholder="png,jpg" name="profile"
						accept="image/gif, image/jpeg, image/png"
						value="${modifyMember.profile }" />
				</div>
			</div>
		</div>
		<div class="mt-5 mb-5 d-flex justify-content-center">
			<div class="">
				<button type="submit" class="btn btn-primary" id="btnSubmit">회원정보
					수정</button>
